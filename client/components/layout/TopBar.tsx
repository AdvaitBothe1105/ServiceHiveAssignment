  ...
  return (
    <header className="flex flex-wrap items-center justify-between gap-4 border-b border-border/70 bg-card/50 px-8 py-6">
      ...
      <div className="flex flex-1 justify-end gap-4">
        <div className="flex min-w-[220px] items-center gap-2 rounded-full border border-border/70 bg-background/80 px-4 py-2 text-sm">
          <span className="text-xs uppercase tracking-[0.3em] text-muted-foreground">Search</span>
          <input
            placeholder="Leads, users, signals"
